...
func (w *wrapper) Scan(imageRef ImageRef) (*trivy.Report, error) {
	...
	return w.parseScanningResult(reportFile)
}

func (w *wrapper) parseScanningResult(reportFile io.Reader) (*trivy.Report, error) {
