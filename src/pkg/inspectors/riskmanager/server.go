...
import (
	...
	riskdata "github.com/vmware-tanzu/cloud-native-security-inspector/src/pkg/inspectors/riskmanager/data"
	"github.com/vmware-tanzu/cloud-native-security-inspector/src/pkg/inspectors/riskmanager/types"
	"net/http"
	"os"
	"strings"
	"time"
