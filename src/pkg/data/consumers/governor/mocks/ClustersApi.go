...
// GenerateAgentConfig provides a mock function with given fields: ctx, clusterId
func (_m *ClustersApi) GenerateAgentConfig(ctx context.Context, clusterId string) openapi.ApiGenerateAgentConfigRequest {
	ret := _m.Called(ctx, clusterId)

	var r0 openapi.ApiGenerateAgentConfigRequest
	if rf, ok := ret.Get(0).(func(context.Context, string) openapi.ApiGenerateAgentConfigRequest); ok {
		r0 = rf(ctx, clusterId)
	} else {
		r0 = ret.Get(0).(openapi.ApiGenerateAgentConfigRequest)
	}

	return r0
}

// GenerateAgentConfigExecute provides a mock function with given fields: r
func (_m *ClustersApi) GenerateAgentConfigExecute(r openapi.ApiGenerateAgentConfigRequest) (string, *http.Response, error) {
	ret := _m.Called(r)

	var r0 string
	var r1 *http.Response
	var r2 error
	if rf, ok := ret.Get(0).(func(openapi.ApiGenerateAgentConfigRequest) (string, *http.Response, error)); ok {
		return rf(r)
	}
	if rf, ok := ret.Get(0).(func(openapi.ApiGenerateAgentConfigRequest) string); ok {
		r0 = rf(r)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(openapi.ApiGenerateAgentConfigRequest) *http.Response); ok {
		r1 = rf(r)
	} else {
		if ret.Get(1) != nil {
	...
	if rf, ok := ret.Get(2).(func(openapi.ApiGenerateAgentConfigRequest) error); ok {
		r2 = rf(r)
	} else {
		r2 = ret.Error(2)
	}
